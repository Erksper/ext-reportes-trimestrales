define('reportes-trimestrales:views/reportes-3-meses-2026/list-with-buttons', ['view'], function (Dep) {
    
    return Dep.extend({
        
        template: 'reportes-trimestrales:reportes-3-meses-2026/list-with-buttons',
        
        setup: function () {
            this.headerTitle = 'Reportes 3 Meses 2026';
        ...
        showReportView: function(reportId, reportLabel) {
            ...
            var reportPath = 'client/custom/modules/reportes-trimestrales/res/reports/reportes-3-meses-2026/' + reportId + '.html';
