define('reportes-trimestrales:views/reportes-12-meses/list-with-buttons', ['view'], function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.reportOptions = [
                ...
                {id: 'CLACaracasLibertador4t', label: 'CLA Caracas Libertador', icon: 'fas fa-map-marker'},
                {id: 'CLACaracasNoreste4t', label: 'CLA Caracas Noreste', icon: 'fas fa-map-marker'},
                {id: 'CLACaracasSureste4t', label: 'CLA Caracas Sureste', icon: 'fas fa-map-marker'},
                {id: 'CLACentroOccidente4t', label: 'CLA Centro Occidente', icon: 'fas fa-map-marker'},
                {id: 'CLALlanoAndes4t', label: 'CLA Llanos Andes', icon: 'fas fa-map-marker'},
                {id: 'CLAOrienteInsular4t', label: 'CLA Oriente Insular', icon: 'fas fa-map-marker'},
                {id: 'CLAOrienteNorte4t', label: 'CLA Oriente Norte', icon: 'fas fa-map-marker'},
                {id: 'CLAOrienteSur4t', label: 'CLA Oriente Sur', icon: 'fas fa-map-marker'},
                {id: 'CLAZulia4t', label: 'CLA Zulia', icon: 'fas fa-map-marker'}
            ];
        },
        ...
        showReportView: function(reportId, reportLabel) {
            ...
            var reportPath = 'client/custom/modules/reportes-trimestrales/res/reports/reportes-12-meses/' + reportId + '.html';
