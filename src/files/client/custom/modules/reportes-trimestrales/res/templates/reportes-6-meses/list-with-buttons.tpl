            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <i class="fas fa-chart-line"></i> Selecciona un Reporte 6 Meses 2025
                    </h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="alert alert-info" style="margin-top: 20px;">
                        ...
                        <strong>Información:</strong> Selecciona uno de los reportes de arriba para ver los datos de los primeros 6 meses.
                    </div>
                </div>
            </div>
        </div>
