...
```
(npm run sync; cd site; vendor/bin/phpunit tests/unit/Espo/Modules/ReportesTrimestrales)
```
...
```
(npm run sync; cd site; vendor/bin/phpunit tests/integration/Espo/Modules/ReportesTrimestrales)
```
...
If your extension contains additional PHP packages, you also need to add `site/custom/Espo/Modules/ReportesTrimestrales/vendor` to the *scanDirectories* section in *phpstan.neon* config.
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/ReportesTrimestrales`
* `site/tests/integration/Espo/Modules/ReportesTrimestrales`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/ReportesTrimestrales/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/ReportesTrimestrales/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/reportes-trimestrales/lib/init.js"
        ]
    }
    ```
...
Add the library module path to `src/files/custom/Espo/Modules/ReportesTrimestrales/Resources/metadata/app/jsLibs.json`

```json
{
    "some-lib": {
        "path": "client/custom/modules/reportes-trimestrales/lib/some-lib.js"
    }
}
```
